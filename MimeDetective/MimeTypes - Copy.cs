...
namespace MimeDetective
{
    ...
    public static class MimeTypes
    {
        ...
        static MimeTypes()
        {
            types = new List<FileType> {PDF, WORD, EXCEL, JPEG, JPEG_2, ZIP, RAR, RTF, PNG, PPT, GIF, GIF_2, DLL_EXE, MSDOC,
                BMP, DLL_EXE, ZIP_7z, ZIP_7z_2, GZ_TGZ, TAR_ZH, TAR_ZV, OGG, ICO, XML, MIDI, FLV, WAVE, DWG, LIB_COFF, PST, PSD,
                AES, SKR, SKR_2, PKR, EML_FROM, ELF, TIFF, TIFF_2, TXT_UTF8, TXT_UTF16_BE, TXT_UTF16_LE, TXT_UTF32_BE, TXT_UTF32_LE,
                DOC_8};
        }
       ...
       // public readonly static FileType PDF = new FileType(new byte?[] { 0x25, 0x50, 0x44, 0x46 }, 1019, "pdf", "application/pdf");
        ...
        public readonly static FileType JPEG = new FileType(new byte?[] { 255, 216, 255, 224 }, "jpg", "image/jpeg");
        public readonly static FileType JPEG_2 = new FileType(new byte?[] { 255, 216, 255, 225 }, "jpg", "image/jpeg");
        //public readonly static FileType PNG = new FileType(new byte?[] { 0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A }, "png", "image/png");
        public readonly static FileType PNG = new FileType(new byte?[] { 137, 80, 78, 71 }, "png", "image/png");
        //public readonly static FileType GIF = new FileType(new byte?[] { 0x47, 0x49, 0x46, 0x38, null, 0x61 }, "gif", "image/gif");
        public readonly static FileType GIF = new FileType(new byte?[] { 0x47, 0x49, 0x46, 0x38, 0x37, 0x61 }, "gif", "image/gif");
        public readonly static FileType GIF_2 = new FileType(new byte?[] { 0x47, 0x49, 0x46, 0x38, 0x39, 0x61 }, "gif", "image/gif");
        ...
        public readonly static FileType TIFF = new FileType(new byte?[] { 73, 73, 42 }, "tif", "image/tiff");
        public readonly static FileType TIFF_2 = new FileType(new byte?[] { 77, 77, 42 }, "tif", "image/tiff");
